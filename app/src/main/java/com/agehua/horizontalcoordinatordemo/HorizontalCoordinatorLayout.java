...
public class HorizontalCoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    static {
        final Package pkg = HorizontalCoordinatorLayout.class.getPackage();
     ...
     * {@link Behavior#onDependentViewChanged(HorizontalCoordinatorLayout, View, View)} to the associated
     ...
     * {@link HorizontalCoordinatorLayout} in the view hierarchy.
     *
     ...
     * when used as a direct child of an {@link HorizontalCoordinatorLayout}. The default behavior
    ...
    /**
     * Interaction behavior plugin for child views of {@link HorizontalCoordinatorLayout}.
     *
    ...
    public static abstract class Behavior<V extends View> {
         ...
         * {@link Color#BLACK}.
         * @see #getScrimOpacity(HorizontalCoordinatorLayout, View)
         */
        @ColorInt
        public int getScrimColor(HorizontalCoordinatorLayout parent, V child) {
            return Color.BLACK;
        }
        ...
        public float getScrimOpacity(HorizontalCoordinatorLayout parent, V child) {
            return 0.f;
        }
         ...
         * {@link #getScrimOpacity(HorizontalCoordinatorLayout, View)} would return > 0.0f.</p>
         *
         * @param parent the parent view of the given child
         * @param child  the child view to test
         * @return true if {@link #getScrimOpacity(HorizontalCoordinatorLayout, View)} would
         * return > 0.0f.
         */
        public boolean blocksInteractionBelow(HorizontalCoordinatorLayout parent, V child) {
         ...
         * false otherwise
         * @see #onDependentViewChanged(HorizontalCoordinatorLayout, View, View)
         */
        public boolean layoutDependsOn(HorizontalCoordinatorLayout parent, V child, View dependency) {
            return false;
        }
         ...
         * {@link #layoutDependsOn(HorizontalCoordinatorLayout, View, View)} or
         * if {@code child} has set another view as it's anchor.</p>
         *
         * <p>Note that if a Behavior changes the layout of a child via this method, it should
         * also be able to reconstruct the correct position in
         * {@link #onLayoutChild(HorizontalCoordinatorLayout, View, int) onLayoutChild}.
         ...
         */
        public boolean onDependentViewChanged(HorizontalCoordinatorLayout parent, V child, View dependency) {
            return false;
        }
         ...
         * {@link HorizontalCoordinatorLayout#onMeasureChild(View, int, int, int, int)
         ...
         * {@link HorizontalCoordinatorLayout#onLayoutChild(View, int)
         * parent.onLayoutChild}.</p>
         *
         * <p>If a Behavior implements
         * {@link #onDependentViewChanged(HorizontalCoordinatorLayout, View, View)}
         ...
         */
        public boolean onLayoutChild(HorizontalCoordinatorLayout parent, V child, int layoutDirection) {
            return false;
        }

        /**
         * @deprecated You should now override
         * {@link #onStartNestedScroll(HorizontalCoordinatorLayout, View, View, View, int, int)}. This
         * method will still continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public boolean onStartNestedScroll(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
         ...
         *
         * @param horizontalCoordinatorLayout the CoordinatorLayout parent of the view this Behavior is
         *                                    associated with
        ...
        public boolean onStartNestedScroll(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
            ...
            if (type == ViewCompat.TYPE_TOUCH) {
                return onStartNestedScroll(horizontalCoordinatorLayout, child, directTargetChild,
                        target, axes);
            }
            return false;
        }
        ...
        /**
         * @deprecated You should now override
         * {@link #onNestedScrollAccepted(HorizontalCoordinatorLayout, View, View, View, int, int)}. This
         * method will still continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public void onNestedScrollAccepted(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
                                           @NonNull V child, @NonNull View directTargetChild, @NonNull View target,
                                           @ScrollAxis int axes) {
            // Do nothing
        }
        ...
        public void onNestedScrollAccepted(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
                                           ...
                                           @ScrollAxis int axes, @NestedScrollType int type) {
            if (type == ViewCompat.TYPE_TOUCH) {
                onNestedScrollAccepted(horizontalCoordinatorLayout, child, directTargetChild,
                        target, axes);
            }
        }
        ...
        /**
         * @deprecated You should now override
         * {@link #onStopNestedScroll(HorizontalCoordinatorLayout, View, View, int)}. This method will still
         * continue to be called if the type is {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
        public void onStopNestedScroll(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
        ...
        public void onStopNestedScroll(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
            ...
            if (type == ViewCompat.TYPE_TOUCH) {
                onStopNestedScroll(horizontalCoordinatorLayout, child, target);
            }
        }

        /**
         * @deprecated You should now override
         * {@link #onNestedScroll(HorizontalCoordinatorLayout, View, View, int, int, int, int, int)}.
        ...
        /**
         * @deprecated You should now override
         * {@link #onNestedPreScroll(HorizontalCoordinatorLayout, View, View, int, int, int[], int)}.
         * This method will still continue to be called if the type is
         * {@link ViewCompat#TYPE_TOUCH}.
         */
        @Deprecated
         ...
         */
        public boolean onNestedFling(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
         ...
         */
        public boolean onNestedPreFling(@NonNull HorizontalCoordinatorLayout horizontalCoordinatorLayout,
                                        @NonNull V child, @NonNull View target, float velocityX, float velocityY) {
            return false;
        }
         ...
         */
        @NonNull
        public WindowInsetsCompat onApplyWindowInsets(HorizontalCoordinatorLayout horizontalCoordinatorLayout,
         ...
         */
        public boolean onRequestChildRectangleOnScreen(HorizontalCoordinatorLayout horizontalCoordinatorLayout,
         ...
         */
        public void onRestoreInstanceState(HorizontalCoordinatorLayout parent, V child, Parcelable state) {
            // no-op
        }
         ...
         *
         * <p>Behavior state is only saved when both the parent {@link HorizontalCoordinatorLayout} and
         ...
         */
        public boolean getInsetDodgeRect(@NonNull HorizontalCoordinatorLayout parent, @NonNull V child,
                                         @NonNull Rect rect) {
            return false;
        }
    }
    ...
    /**
     * Parameters describing the desired layout for a child of a {@link HorizontalCoordinatorLayout}.
     */
    public static class LayoutParams extends MarginLayoutParams {
         ...
         *
         * @see #isBlockingInteractionBelow(HorizontalCoordinatorLayout, View)
         */
         ...
         */
        boolean isBlockingInteractionBelow(HorizontalCoordinatorLayout parent, View child) {
         ...
         */
        boolean dependsOn(HorizontalCoordinatorLayout parent, View child, View dependency) {
         ...
         * {@link #findAnchorView(HorizontalCoordinatorLayout, View) found} before
         * being used again.
         */
         ...
         * {@link View#NO_ID}.
         */
        View findAnchorView(HorizontalCoordinatorLayout parent, View forChild) {
         ...
         */
        private void resolveAnchorView(final View forChild, final HorizontalCoordinatorLayout parent) {
         ...
         */
        private boolean verifyAnchorView(View forChild, HorizontalCoordinatorLayout parent) {
