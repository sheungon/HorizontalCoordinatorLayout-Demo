 ...
 */
class ViewOffsetBehavior<V extends View> extends HorizontalCoordinatorLayout.Behavior<V> {
    ...
    protected void layoutChild(HorizontalCoordinatorLayout parent, V child, int layoutDirection) {
